...
//  RickAndMorty2023
//
//  Created by Alex Murphy on 06.04.2023.
//
...
final class RMLocationDetailViewViewModel {
	...
	public private(set) var cellViewModels: [SectionType] = [] // Not allowed to delete or modify sections. Public, but only for reading
